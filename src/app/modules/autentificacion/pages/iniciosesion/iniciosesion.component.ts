...
export class IniciosesionComponent {
  ...
  async iniciarSesion() {
    ...
    try {
      ...
      //verificamos que el usuario de la BD sea existente o sea igual al de nuestra colección
      ...
      //extra los datos en forma de objeto y se especifíca que va a ser del tipo "usuario" (se refiere a la interfaz "Usuario" de nuestros modelos)
      const usuarioData = usuarioDoc.data() as Usuario;
      //encripta la contraseña que el usuario envia en "inicio sesión"
      const hashedPassword = CryptoJS.SHA256(credenciales.password).toString();

      //condicional que compara la contraseña que acabamos de encriptar y que el usuario envió, con la que recibimos del "usuarioData"
