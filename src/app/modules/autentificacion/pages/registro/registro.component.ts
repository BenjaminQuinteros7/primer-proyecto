...
export class RegistroComponent {
  ...
  async registrar(){
    ...
    /**
     _ SHA-256: Es un algoritmo de hash seguro que toma una entrada (en este caso la contraseña) 
     y produce una cadena de caracteres HEXADECIMAL que va a representar a su hash.
     _ toString: Convierte el resultado en la cadena de caracteres legible.
     */
